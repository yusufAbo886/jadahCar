    ...
    <div class="card card-custom">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{asset('admin/category/create')}}" class="btn btn-primary font-weight-bolder">
                ...
                @foreach( $category as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <button  class="btn btn-light-primary font-weight-bold delete" url="{{route('category.destroy',$item->id)}}" id="{{ $item->id }}" content="{{csrf_token()}}"><i class='glyphicon glyphicon-trash text-danger'></i></button>
