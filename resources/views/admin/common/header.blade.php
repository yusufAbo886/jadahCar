...
<head><base href="">
    ...
    <link href="{{ asset('css/admin/jasny-bootstrap.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('assets/still.css') }}" rel="stylesheet" type="text/css" />
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            ...
                            <a href="/admin" class="menu-link">
										...
										<span class="svg-icon menu-icon" style=" ">
                                ...
                                <span style="font-size: 15px; color: white"  class="menu-text">Dashboard</span>
                        ...
                        <li id="customer" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text" style="font-size: 15px ;color:white" > Customers</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li  id="posts" class="menu-item" aria-haspopup="true">

                                        <a href="{{asset('admin/hospital-posts')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">Hospital Posts </span>
                        ...
                        <li id="pages" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text" style="font-size: 15px ;color:white" > Anasayfa</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li  id="clinic" class="menu-item" aria-haspopup="true">

                                        <a href="{{asset('admin/clinic')}}" class="menu-link">
                          ...
                          <li id="category" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                      ...
                      <span class="svg-icon menu-icon">
                        ...
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                          ...
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z" fill="#000000" opacity="0.3" />
                                  ...
                                  <span style="font-size: 15px ;color:white" class="menu-text">Category</span>
                              ...
                              <div class="menu-submenu">
                                  ...
                                  <ul class="menu-subnav">
                                    ...
                                    <li id="categories" class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="{{asset('admin/category')}}" class="menu-link">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">Categories</span>
                                      ...
                                      <li id="subcategory" class="menu-item" aria-haspopup="true">

                                          <a href="{{asset('admin/subcategory')}}" class="menu-link">
                                              ...
                                              <span style="font-size: 14px ;" class="menu-text">Subcategories</span>
                        ...
                        <li class="menu-section">
                            ...
                            <h4 class="menu-text">Common Sections</h4>

                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>

                        </li>
                        <!-- stat -->
                        <li id="form" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          ...
                          <path d="M17.9142136,15.4497475 C18.4664983,15.4497475 18.9142136,15.8974627 18.9142136,16.4497475 L18.9142136,18.4497475 C18.9142136,19.0020322 18.4664983,19.4497475 17.9142136,19.4497475 C17.3619288,19.4497475 16.9142136,19.0020322 16.9142136,18.4497475 L16.9142136,16.4497475 C16.9142136,15.8974627 17.3619288,15.4497475 17.9142136,15.4497475 Z M23.4497475,17.1568542 C23.8402718,17.5473785 23.8402718,18.1805435 23.4497475,18.5710678 L22.0355339,19.9852814 C21.6450096,20.3758057 21.0118446,20.3758057 20.6213203,19.9852814 C20.2307961,19.5947571 20.2307961,18.9615921 20.6213203,18.5710678 L22.0355339,17.1568542 C22.4260582,16.76633 23.0592232,16.76633 23.4497475,17.1568542 Z M12.6213203,17.1568542 C13.0118446,16.76633 13.6450096,16.76633 14.0355339,17.1568542 L15.4497475,18.5710678 C15.8402718,18.9615921 15.8402718,19.5947571 15.4497475,19.9852814 C15.0592232,20.3758057 14.4260582,20.3758057 14.0355339,19.9852814 L12.6213203,18.5710678 C12.2307961,18.1805435 12.2307961,17.5473785 12.6213203,17.1568542 Z" fill="#000000" opacity="0.3" transform="translate(18.035534, 17.863961) scale(1, -1) rotate(45.000000) translate(-18.035534, -17.863961)" />
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text">Formlar</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                  ...
                                  <li id="iletisimForm" class="menu-item" aria-haspopup="true">

                                      <a href="{{asset('admin/iletisim-form')}}" class="menu-link">
                                          ...
                                          <span style="font-size: 14px ;" class="menu-text">Iletişim Formu</span>
                        ...
                        <li id="setting" class="menu-item" aria-haspopup="true">
                            ...
                            <a href="{{asset('admin/setting')}}" class="menu-link">
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text">settings</span>
                        ...
                        <!-- <li class="menu-item" aria-haspopup="true">
                            ...
                            <a href="{{asset('admin/menu-link')}}" class="menu-link">
										...
										<span class="svg-icon menu-icon">
											...
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        ...
                                                        <span style="font-size: 15px ;color:white" class="menu-text">menu-link</span>
        ...
        <div id="kt_header" class="header header-fixed">
            ...
            <div class="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-item" style="margin-left:90%">
                        ...
                        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">
                            ...
                            <a href="/panel/logout"> <span style="padding-left: 20px;" class="symbol symbol-lg-35 symbol-25 symbol-light-danger">

    											<span style="padding-left: 40px;padding-right: 40px;" class="symbol-label  font-weight-bold"> logout</span>
