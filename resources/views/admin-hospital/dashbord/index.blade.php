                        ...
                        <div class="card-spacer mt-n25">
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                    ...
                                    <a style="float: left" class="text-primary font-weight-bold font-size-h6 mt-2">Our Users</a>
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                    ...
                                    <a style="float: left;" class="text-danger font-weight-bold font-size-h6 mt-2">Properties</a>
                                ...
                                <div class="col bg-light-success px-6 py-8 rounded-xl">
                                    ...
                                    <a class="text-success font-weight-bold font-size-h6 mt-2">SEO</a>
                                </div>
                            </div>
                            <!--end::Row-->
                        </div>
